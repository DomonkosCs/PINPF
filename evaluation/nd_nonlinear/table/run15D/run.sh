...
python3 evaluation/nd_nonlinear/table/create_comparison.py \
    ...
    --model-path             checkpoints/nonlinear_15d/model_epoch_best.pth \
    --train-config           checkpoints/nonlinear_15d/train_config.json \
    --mode                   test \
    --d-lambda               0.5 \
    --n-particles            2000 \
    --gt-path                data/nonlinear_15d/gt_test.pt \
    --gt-samples             10000 \
    --seed                   42 \
